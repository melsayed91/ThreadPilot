...
public class VehicleTests
{
    ...
    public void Creates_vehicle_with_normalized_reg_and_trimmed_fields()
    {
        ...
        var v = new Vehicle(reg, "  Tesla  ", "  Model 3 ", 2022, " 5YJ3E1EA7KF317000 ");
    ...
    {
        var act = () => new Vehicle(RegistrationNumber.From("ABC123"), make!, "Model", 2020, "VIN");
    ...
    {
        var act = () => new Vehicle(RegistrationNumber.From("ABC123"), "Tesla", model!, 2020, "VIN");
    ...
    {
        var act = () => new Vehicle(RegistrationNumber.From("ABC123"), "Tesla", "Model 3", 2020, vin!);
